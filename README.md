...
3. inside yolov5 folder download the trained weights (choose version (l or x l is faster x is better) and adjust image size if different from roboflow)
`python detect.py --weights yolov5l.pt --img 640` 
(the weights present are in the google folder)
